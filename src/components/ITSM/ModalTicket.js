...
const Modal = ({ data, onClose }) => {
    ...
    useEffect(() => {
        if (selectedHub) {
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/unidade?hub=${selectedHub}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
    ...
    useEffect(() => {
        if (selectedCategoria) {
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/subcategorias?categoria=${selectedCategoria}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
    ...
    useEffect(() => {
        if (selectedSubcategoria) {
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/assuntos?categoria=${selectedCategoria}&subcategoria=${selectedSubcategoria}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
    ...
    useEffect(() => {
        const fetchAtividades = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/ticket-tasks?id=${data.id}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } });
    ...
    useEffect(() => {
        const fetchFiles = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/ticket-files?id=${data.id}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } });
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/status`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
            .then(response => {
        ...
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/usuarios-executores`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
            .then(response => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/sla`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
            .then(response => {
    ...
    useEffect(() => {
        if (
            ...
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/dominios-email`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } })
                .then(response => {
    ...
    const getEmailsForQueue = async (executor, unidade) => {
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tickets/form/email-fila?id_fila=${executor}&unidade=${unidade}`, { headers: { 'Authorization': `Bearer ${token}`, 'X-User-Email': user.email } });
        return response.data;
    };
